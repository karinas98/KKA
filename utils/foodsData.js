const foodData = {
  foods: [
    {
      foodUrl:
        'https://asset.cloudinary.com/de9zdtobn/386eb8e351c6d3e0116c2906d415de78',
      name: 'Pizza',
      origin: 'Naples, Italy, 1889',
      flagUrl:
        'https://asset.cloudinary.com/de9zdtobn/0513f3e2fde8fd6e76149adf27cc8f0a',
    ...
    {
      foodUrl:
        'https://asset.cloudinary.com/de9zdtobn/3e13c9f702e3c78591c98536cb8dab3c',
      name: 'Sushi',
      origin: 'Japan, 1824',
      flagUrl:
        'https://asset.cloudinary.com/de9zdtobn/82d51fdbf6ec4fb0147da82503fb3400',
      description: `Sushi is Japan's most famous culinary representative, typically made with rice and fillings which have been rolled inside a sheet of dry seaweed. However, the term sushi is actually an umbrella term covering a wide range of subvarieties which can be made with a myriad of different ingredients and in as many forms and presentations.
    ...
    },
    {
      ...
      flagUrl:
        'https://asset.cloudinary.com/de9zdtobn/3109171b9d2014c895cf205c481725e9',
      description: `A quintessential American food, burger evolved from the German Deutsches beefsteak, according to the New York Times food critic Mimi Sheraton. Its other name (hamburger) is a result of the fact that many German immigrants originally came from the port of Hamburg.
    ...
    {
      foodUrl:
        'https://asset.cloudinary.com/de9zdtobn/d41503b9cdba5c752e35546e10922022',
      name: 'Ramen',
      origin: 'Japan, 1910',
      flagUrl:
        'https://asset.cloudinary.com/de9zdtobn/82d51fdbf6ec4fb0147da82503fb3400',
      description: `Ramen is a noodle soup that first appeared in Japan in 1910, when 
      Chinese cooks combined the noodles with a salty broth. These curly noodles were of bright yellow color
       and more elastic than the Japanese noodles prepared at the time – the dough 
       was kneaded witha sodium carbonate-infused mineral water called kansui.
       In 1958, its name was derived from the pronunciation of the Chinese word lamian (pulled noodles), and that same year,
    ...
    {
      foodUrl:
        'https://asset.cloudinary.com/de9zdtobn/941b9d4a4d06827332dabfa41b69036c',
      name: 'Cellophane Noodles',
      origin: 'China, 4,000 years ago',
      flagUrl:
        'https://asset.cloudinary.com/de9zdtobn/4279bf2f05fcee35924560e03f227952',
      description: `Also known as Chinese vermicelli and glass noodles, these thin noodles are made from water
       and starch extracted from mung beans, yams, cassava, or potato. They are characterized by their translucent
        appearance and extremely mild flavor. Cellophane noodles are often used in soups and stir-fries, but can also be served cold in salads.
        They tend to soften quickly when used in soups, while they remain al dente and soak up the flavors of other
        ingredients when used in stir-fries. The noodles are commonly flavored with vinegar, fish sauce, soy sauce, or chili oil.
    ...
    {
      foodUrl:
        'https://asset.cloudinary.com/de9zdtobn/36a32c0195e5fc628ed48b78b99067b6',
      name: 'Tofu',
      origin: 'JIANGSU, China, 2nd century BC',
      flagUrl: 'https://asset.cloudinary.com/de9zdtobn/4279bf2f05fcee35924560e03f227952',
    ...
    {
      foodUrl: 'https://asset.cloudinary.com/de9zdtobn/46f18f35e126bb3ba9ff3690a5df86d1',
      name: 'Croissant',
      origin: 'France, 1683',
      flagUrl: 'https://asset.cloudinary.com/de9zdtobn/e8fa465529a96f4b3ffdb712130196aa',
    ...
    {
      foodUrl: 'https://asset.cloudinary.com/de9zdtobn/f4a88df4eee1bfc2f69260593ff4e40b',
      name: 'Tortilla',
      origin: 'Mexico 10,000 BC',
      flagUrl: 'https://cdn.britannica.com/73/2573-004-29818847/Flag-Mexico.jpg',
      description: `Tortilla, originally a corn flatbread, is one of the essential bread varieties that has been present in Mexican culture for thousands of years. The first tortilla was created out of the staple ingredient of indigenous cultures, the ubiquitous corn.
