...
const getById= async(req,res,next)=>{
    ...
    try{
        ...
        if (!getIndividual){
            ...
            res.status(404).json({succes:false, msg:`the food with the id ${getIndividual} can't find` })
        ...
        return res
          ...
          .json({
            succes: true,
            msg: "the food with the id has been found", data: getIndividual,
          });
...
const create = async(req,res,next)=>{
    ...
    try{
        ...
        return res
          ...
          .json({
            success: true,
            msg: "the food with the id has been found", data: createdFood,
          });
